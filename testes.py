...
from lists.batata_quente import batata_quente
from lists.eh_palindromo import eh_palindromo
...
#testes com a função batata quente
# batata_quente(["joão","maria","thiago","aline","Diego","taturana"],12313)

#teste com a função é palindromo
eh_palindromo("arara")
eh_palindromo("botijao")
eh_palindromo("hannah")
eh_palindromo("texugo")